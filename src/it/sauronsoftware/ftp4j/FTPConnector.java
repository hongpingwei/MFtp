...
public abstract class FTPConnector {
	...
	//mj
	protected Socket tcpConnectBindLocalForCommunicationChannel(String host, int port, String local_ip) throws IOException {
		...
		try {
			...
			InetSocketAddress address = new InetSocketAddress(InetAddress.getByName(local_ip), 0);
			connectingCommunicationChannelSocket.bind(address);
			connectingCommunicationChannelSocket.setSoTimeout(readTimeout * 1000);
			connectingCommunicationChannelSocket.setSoLinger(true, closeTimeout);
			connectingCommunicationChannelSocket.connect(new InetSocketAddress(host, port), connectionTimeout * 1000);
			return connectingCommunicationChannelSocket;
	...
	protected Socket tcpConnectBindLocalForCommunicationChannel(String host, int port, String local_ip, int local_port) throws IOException {
		if(null == local_ip || "" == local_ip)
			return tcpConnectForCommunicationChannel(host, port);
		...
		try {
			...
			InetSocketAddress address = new InetSocketAddress(InetAddress.getByName(local_ip), local_port);
			connectingCommunicationChannelSocket.bind(address);
			connectingCommunicationChannelSocket.setSoTimeout(readTimeout * 1000);
			connectingCommunicationChannelSocket.setSoLinger(true, closeTimeout);
			connectingCommunicationChannelSocket.connect(new InetSocketAddress(host, port), connectionTimeout * 1000);
	...
	//mj
	protected Socket tcpConnectForDataTransferChannel(String host, int port, String local_ip) throws IOException {
